...
function clickable(req, config, widget) {
     ...
     $("#easy-reading-clickable-style").remove();
     $("<style id='easy-reading-clickable-style' type='text/css'> .easyReaderClickable{ color:"+config.fontColor+" !important; background-color:"+config.backgroundColor+" !important;} </style>").appendTo("head");
    ...
    //             $(this).addClass("easyReaderClickable");

    //        }
    //         // (this.tagName === "BUTTON" ||
    //         // this.tagName === "A" || (this.onclick != null) || window.getComputedStyle(this).cursor == "pointer")
